    ...
    <div class="row">
    	...
    	<div class="col-xs-12 col-sm-9"></div>
			<div class="col-xs-12 col-sm-3">
				<a href="<?php echo PASTASISTEMA?>Conta/Incluir_usuario" class="btn btn-default">
					<span class="glyphicon glyphicon-plus"></span> Incluir Usuário
				</a>
			        ...
			        <div class="row">
			            <div class="col-xs-12">
			                ...
			                <tbody>
			                    ...
			                    ?>
			                            <tr id="Item<?php echo $value['ID']?>">
											<td>
    	                                        ...
    	                                        <a href="<?php echo PASTASISTEMA?>Conta/Alterar_usuario/<?php echo $value['ID']?>" title="Editar usuário" data-toggle="tooltip"><span class="glyphicon glyphicon-pencil" style="font-size:20px; color:#000"></span></a>
    	                                    </td>
			                    ...
			                    ?>
                                <tr>
                                    <td colspan="3"><button type="button" id="ExcluirItem" style="margin-top:20px" class="btn btn-default btn-sm">Excluir Usuário(s)</button></td>
                                </tr> 
			                </tbody>
			                </table>
			            </div>
	...
	$("#ExcluirItem").click(function(){
		...
		if(strItens!=""){
			$.ajax({
				type: "POST", 
				dataType: "json",
				url: "<?php echo PASTASISTEMA?>Conta/Delete_usuarios", 
				data: "itens="+strItens, 
